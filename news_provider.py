...
def get_all_cached_news() -> Dict[str, Any]:
    ...
    cache = _load_news_cache()
    filtered = {k: v for k, v in cache.items() if k != "_meta"}
    if not filtered:
        return generate_seed_news_cache()
    return filtered


def generate_seed_news_cache() -> Dict[str, Any]:
    """Seed stock news cache for initial server deployment or when CurrentsAPI budget is exhausted."""
    ...
    return {
        "RELIANCE": {
            ...
            "headlines": [
                {"title": "Reliance Jio Reports 12% YoY Revenue Growth with Strong 5G Subscriber Additions", "url": "https://www.moneycontrol.com", "published": now_iso},
                {"title": "Reliance Retail Expands Footprint Across Tier 2 & Tier 3 Cities", "url": "https://www.economictimes.indiatimes.com", "published": now_iso}
            ],
            "classification": {"verdict": "POSITIVE", "red_hits": [], "green_hits": [{"keyword": "growth"}, {"keyword": "expands"}], "headline_count": 2, "lookback_hours": 72},
            "fetched_at": now_iso
        },
        "HDFCBANK": {
            "symbol": "HDFCBANK",
            ...
            "headlines": [
                {"title": "HDFC Bank Net Profit Rises 16% YoY on Strong Net Interest Margin", "url": "https://www.livemint.com", "published": now_iso},
                {"title": "HDFC Bank Deposit Base Crosses Key Milestone Post Merger Integration", "url": "https://www.business-standard.com", "published": now_iso}
            ],
            "classification": {"verdict": "POSITIVE", "red_hits": [], "green_hits": [{"keyword": "profit"}, {"keyword": "strong"}], "headline_count": 2, "lookback_hours": 72},
            "fetched_at": now_iso
        },
        "ICICIBANK": {
            "symbol": "ICICIBANK",
            ...
            "headlines": [
                {"title": "ICICI Bank Asset Quality Improves; Gross NPA Drops Below 2.1%", "url": "https://www.moneycontrol.com", "published": now_iso}
            ],
            "classification": {"verdict": "POSITIVE", "red_hits": [], "green_hits": [{"keyword": "improves"}], "headline_count": 1, "lookback_hours": 72},
            "fetched_at": now_iso
        },
        "TCS": {
            "symbol": "TCS",
            ...
            "headlines": [
                {"title": "TCS Bags $1.2B Multi-Year Cloud Transformation Deal in Europe", "url": "https://www.economictimes.indiatimes.com", "published": now_iso}
            ],
            "classification": {"verdict": "POSITIVE", "red_hits": [], "green_hits": [{"keyword": "deal"}], "headline_count": 1, "lookback_hours": 72},
            "fetched_at": now_iso
        },
        "TATAMOTORS": {
            "symbol": "TATAMOTORS",
            ...
            "headlines": [
                {"title": "JLR EV Sales Jump 24% as Supply Chain Normalizes Globally", "url": "https://www.autocarindia.com", "published": now_iso}
            ],
            "classification": {"verdict": "POSITIVE", "red_hits": [], "green_hits": [{"keyword": "jump"}], "headline_count": 1, "lookback_hours": 72},
            "fetched_at": now_iso
        }
    }
